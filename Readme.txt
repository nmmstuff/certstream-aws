Detecting phishing campains based on the certificate transparency logs.

The purpose is to run the certstream-server docker and a custom certstream-client docker in an AWS ECS service (more cost efficiency).
